...
product.check <- train[-product.sample, 95]
...
product.model <- h2o.deeplearning(x = 1:93,  # column numbers for predictors
                   ...
                   hidden_dropout_ratios = c(0.02,0.02,0.02), # % for nodes dropout
...
product.model # print model statistics

h2o.shutdown(prompt = F)

# plotting for quick visual validation
